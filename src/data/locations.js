...
export const locations = [
  {
    ...
    metaDescription:
      "FixAir is Welland's residential HVAC specialist — furnace, AC, ductless and water heater service from Tom, a local tech with 25+ years. Call 905-732-2791.",
    ...
    faqs: [
      {
        ...
        a: 'Yes — Welland is home base for FixAir. That means fast response times and a contractor who knows the area well.',
      },
      {
  ...
  },
  {
    ...
    localDetail: [
      ...
      "Whether you're upgrading to a high-efficiency furnace, adding central air, or troubleshooting a system that isn't keeping up, you'll get a straight answer and clean, careful work — no upselling, no runaround.",
  ...
  },
  {
    ...
    localDetail: [
      ...
      'With FixAir you get a residential-only specialist who does the work himself — honest recommendations, tidy installations, and systems that keep your home comfortable through every season.',
  ...
  },
  {
    ...
    localDetail: [
      ...
      "You'll get the same person every time — Tom assessing your home honestly, installing cleanly, and standing behind the workmanship. No pressure, no upsell, just comfortable temperatures year-round.",
  ...
  },
  {
    ...
    localDetail: [
      ...
      "As a residential-only specialist serving south Niagara, Tom offers something the big companies don't: personal, accountable service from the same technician every time — honest advice and workmanship you can count on.",
