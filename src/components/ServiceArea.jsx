        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-xl order-2 lg:order-1">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-brand-blue/70 to-brand-blue/40 flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <div className="text-2xl font-extrabold">Niagara Region</div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h2 className="section-heading text-left">
              Proudly Serving the{' '}
              <span className="text-brand-orange">Niagara Region</span>
            </h2>
            <p className="mt-4 text-gray-500 leading-relaxed">
              FixAIR serves homeowners throughout Niagara. If you're nearby and don't see your town listed,{' '}
