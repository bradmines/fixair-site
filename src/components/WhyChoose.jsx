  ...
  return (
    <section id="why" className="py-20 md:py-28 bg-brand-blue relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* CTA strip — hidden on mobile; the sticky call bar handles this */}
        <div className="mt-14 text-center hidden sm:block">
          <a href={PHONE_HREF} className="btn-primary text-base px-10 py-4 shadow-xl shadow-brand-orange/30">
